...
\lstdefinelanguage{typescript}{
	morekeywords={abstract,alias,align,asm,assert,auto,body,bool,break,byte,
		...
		super,switch,synchronized,template,this,throw,true,try,typedef,typeid,
		typeof,ubyte,ucent,uint,ulong,union,unittest,ushort,version,void,
		volatile,wchar,while,with,size_t,hash_t,number
	},
	sensitive=True,
	morecomment=[l]{//},
	morecomment=[s]{/\*}{\*/},
...
\begin{frame}
	...
	\lstinputlisting[language=typescript,basicstyle=\tiny,caption={},
		linerange=16-40, firstnumber=16
...
\begin{frame}
	...
	\lstinputlisting[language=typescript,basicstyle=\small,
		title={Typescript}, linerange=16-19, firstnumber=16
...
\begin{figure}[h]
	\begin{tikzpicture}
		\node at (0,3) (D) {
			\lstinputlisting[numbers=none,basicstyle=\tiny,caption={},
				linerange=1-4, firstnumber=1
			]{Sources/VibeAngularExample/source/weather.d}
		};
		\pause
		\node at (0.8,1) (F) {
\begin{lstlisting}[language=d,numbers=none,basicstyle=\tiny,caption={}]
import std.format;
...
\end{lstlisting}
		...
		\pause
		\node at(6,2.0) (T) {
			\lstinputlisting[numbers=none,language=typescript,basicstyle=\tiny,
...
\begin{frame}
	...
	\pause
	\lstinputlisting[basicstyle=\tiny,caption={},linerange=77-79,
		firstnumber=77
	]{Sources/app.d}
	\pause
